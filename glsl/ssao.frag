...
void main (void) {
	...
	vec3 scale = vec3(u_ssaoParms.y *
		min(centerDepth / 2048.0, 1.0) *		// make area smaller if distance is less than 5 meters
		(1.0 + centerDepth / 4096.0));		// make area bigger if distance is more than 32 meters
