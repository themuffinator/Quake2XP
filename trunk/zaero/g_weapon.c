...
//  }
	...
	else
	{
		...
		gi.WriteByte (svc_temp_entity);
		gi.WriteByte (tempevent); // was TE_BLASTER
...
void fire_rocket (edict_t *self, vec3_t start, vec3_t dir, int damage, int speed, float damage_radius, int radius_damage)
{
	...
	rocket->s.renderfx |= RF_NOSHADOW; //Knightmare- no shadow
...
//  }
	...
	T_RadiusDamage(self, self->owner, sk_bfg_rdamage->value, other, 100, MOD_BFG_BLAST);
