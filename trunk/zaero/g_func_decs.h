...
extern bool push_hit ( edict_t * self , vec3_t start , vec3_t aim , int damage , int kick ) ;
...
extern bool fire_lasertripbomb ( edict_t * self , vec3_t start , vec3_t dir , float timer , float damage , float damage_radius , bool quad ) ;
...
extern bool SpawnZ ( gitem_t * item , edict_t * spot ) ;
...
extern bool thruBarrier ( edict_t * targ , edict_t * inflictor ) ;
...
extern bool EMPNukeCheck ( edict_t * ent , vec3_t pos ) ;
...
extern bool hound_checkattack ( edict_t * self ) ;
extern bool hound_check_jump ( edict_t * self ) ;
extern bool hound_check_melee ( edict_t * self ) ;
...
extern void zCam_TrackEntity ( struct edict_s * player , struct edict_s * track , bool playerVisiable , bool playerOffset ) ;
...
extern bool autocannonInfront ( edict_t * self , edict_t * other ) ;
extern bool canShoot ( edict_t * self , edict_t * e ) ;
extern float mod180 ( float val ) ;
extern bool angleBetween ( float * ang , float * , float * ) ;
extern void monster_autocannon_fire ( edict_t * self ) ;
extern void Info_SetValueForKey ( char * s , char * key , char * value ) ;
extern bool Info_Validate ( char * s ) ;
...
extern bool Com_ParseColorString ( const char * s , color_t outColor ) ;
...
extern void weapon_bfg_fire ( edict_t * ent , bool altfire ) ;
extern void Weapon_Railgun ( edict_t * ent ) ;
extern void weapon_railgun_fire ( edict_t * ent , bool altfire ) ;
extern void Weapon_SuperShotgun ( edict_t * ent ) ;
extern void weapon_supershotgun_fire ( edict_t * ent , bool altfire ) ;
extern void Weapon_Shotgun ( edict_t * ent ) ;
extern void weapon_shotgun_fire ( edict_t * ent , bool altfire ) ;
extern void Weapon_Chaingun ( edict_t * ent ) ;
extern void Chaingun_Fire ( edict_t * ent , bool altfire ) ;
extern void Weapon_Machinegun ( edict_t * ent ) ;
extern void Machinegun_Fire ( edict_t * ent , bool altfire ) ;
extern void Weapon_HyperBlaster ( edict_t * ent , bool altfire ) ;
extern void Weapon_HyperBlaster_Fire ( edict_t * ent , bool altfire ) ;
extern void Weapon_Blaster ( edict_t * ent ) ;
extern void Weapon_Blaster_Fire ( edict_t * ent , bool altfire ) ;
extern int Blaster_Fire ( edict_t * ent , vec3_t g_offset , int damage , bool hyper , int effect , int color ) ;
extern void Weapon_RocketLauncher ( edict_t * ent ) ;
extern void Weapon_RocketLauncher_Fire ( edict_t * ent , bool altfire ) ;
extern void Weapon_GrenadeLauncher ( edict_t * ent ) ;
extern void weapon_grenadelauncher_fire ( edict_t * ent , bool altfire ) ;
extern void Weapon_Grenade ( edict_t * ent ) ;
extern void weapon_grenade_fire ( edict_t * ent , bool held ) ;
extern void Weapon_Generic ( edict_t * ent , int FRAME_ACTIVATE_LAST , int FRAME_FIRE_LAST , int FRAME_IDLE_LAST , int FRAME_DEACTIVATE_LAST , int * pause_frames , int * fire_frames , void ( * fire ) ( edict_t * ent , bool altfire ) ) ;
...
extern bool Pickup_Weapon ( edict_t * ent , edict_t * other ) ;
...
extern bool PlayerOnFloor ( edict_t * player ) ;
...
extern bool IsFemale ( edict_t * ent ) ;
...
extern bool mutant_check_jump ( edict_t * self ) ;
extern bool mutant_check_melee ( edict_t * self ) ;
...
extern bool M_MoveAwayFromFlare ( edict_t * self , float dist ) ;
extern bool M_walkmove ( edict_t * ent , float yaw , float dist ) ;
extern void M_MoveToGoal ( edict_t * ent , float dist ) ;
extern bool SV_CloseEnough ( edict_t * ent , edict_t * goal , float dist ) ;
...
extern bool SV_movestep ( edict_t * ent , vec3_t move , bool relink ) ;
extern bool M_CheckBottom ( edict_t * ent ) ;
...
extern void fire_rail ( edict_t * self , vec3_t start , vec3_t aimdir , int damage , int kick , bool useColor , int red , int green , int blue ) ;
...
extern void fire_grenade2 ( edict_t * self , vec3_t start , vec3_t aimdir , int damage , int speed , float timer , float damage_radius , bool held ) ;
extern void fire_grenade ( edict_t * self , vec3_t start , vec3_t aimdir , int damage , int speed , float timer , float damage_radius , bool contact ) ;
...
extern void fire_blaster ( edict_t * self , vec3_t start , vec3_t dir , int damage , int speed , int effect , bool hyper , int color ) ;
...
extern bool fire_hit ( edict_t * self , vec3_t aim , int damage , int kick ) ;
extern void check_dodge ( edict_t * self , vec3_t start , vec3_t dir , int speed ) ;
extern bool MonsterPlayerKillBox ( edict_t * ent ) ;
extern bool MonsterKillBox ( edict_t * ent ) ;
extern bool KillBox ( edict_t * ent ) ;
...
extern bool SV_Push ( edict_t * pusher , vec3_t move , vec3_t amove ) ;
...
extern bool SV_RunThink ( edict_t * ent ) ;
...
extern bool monster_start ( edict_t * self ) ;
...
extern bool Pickup_Visor ( edict_t * ent , edict_t * other ) ;
extern bool Pickup_PlasmaShield ( edict_t * ent , edict_t * other ) ;
...
extern bool Pickup_A2k ( edict_t * ent , edict_t * other ) ;
extern void Drop_Ammo ( edict_t * ent , gitem_t * item ) ;
extern bool Pickup_Ammo ( edict_t * ent , edict_t * other ) ;
extern void SetAmmoPickupValues ( void ) ;
extern bool Add_Ammo ( edict_t * ent , gitem_t * item , int count ) ;
extern bool Pickup_Key ( edict_t * ent , edict_t * other ) ;
...
extern bool Pickup_Pack ( edict_t * ent , edict_t * other ) ;
extern bool Pickup_Bandolier ( edict_t * ent , edict_t * other ) ;
extern bool Pickup_AncientHead ( edict_t * ent , edict_t * other ) ;
extern bool Pickup_Adrenaline ( edict_t * ent , edict_t * other ) ;
extern void Drop_General ( edict_t * ent , gitem_t * item ) ;
extern bool Pickup_Powerup ( edict_t * ent , edict_t * other ) ;
...
extern void door_use_areaportals ( edict_t * self , bool open ) ;
...
extern bool CheckTeamDamage ( edict_t * targ , edict_t * attacker ) ;
...
extern bool CanDamage ( edict_t * targ , edict_t * inflictor ) ;
extern void ClientCommand ( edict_t * ent ) ;
extern void Cmd_Say_f ( edict_t * ent , bool team , bool arg0 ) ;
...
extern bool tryUse ( edict_t * ent , char * s ) ;
...
extern bool OnSameTeam ( edict_t * ent1 , edict_t * ent2 ) ;
extern char * ClientTeam ( edict_t * ent ) ;
extern void ai_run ( edict_t * self , float dist ) ;
extern bool ai_checkattack ( edict_t * self , float dist ) ;
