...
PFNGLISBUFFERPROC						qglListBuffer = NULL;
PFNGLBUFFERDATAPROC						qglBufferData = NULL;
PFNGLBUFFERSUBDATAPROC					qglBufferSubData = NULL;
PFNGLGETBUFFERSUBDATAPROC				qglGetBufferSubDdata = NULL;
...
PFNGLPROGRAMUNIFORM1FEXTPROC				glUniform1fDSA = NULL;
PFNGLPROGRAMUNIFORM2FEXTPROC				glUniform2fDSA = NULL;
PFNGLPROGRAMUNIFORM3FEXTPROC				glUniform3fDSA = NULL;
PFNGLPROGRAMUNIFORM4FEXTPROC				glUniform4fDSA = NULL;
PFNGLPROGRAMUNIFORM1IEXTPROC				glUniform1iDSA = NULL;
PFNGLPROGRAMUNIFORM2IEXTPROC				glUniform2iDSA = NULL;
PFNGLPROGRAMUNIFORM3IEXTPROC				glUniform3iDSA = NULL;
PFNGLPROGRAMUNIFORM4IEXTPROC				glUniform4iDSA = NULL;

PFNGLPROGRAMUNIFORM1FVEXTPROC				glUniform1fvDSA = NULL;
PFNGLPROGRAMUNIFORM2FVEXTPROC				glUniform2fvDSA = NULL;
PFNGLPROGRAMUNIFORM3FVEXTPROC				glUniform3fvDSA = NULL;
PFNGLPROGRAMUNIFORM4FVEXTPROC				glUniform4fvDSA = NULL;
PFNGLPROGRAMUNIFORM1IVEXTPROC				glUniform1ivDSA = NULL;
PFNGLPROGRAMUNIFORM2IVEXTPROC				glUniform2ivDSA = NULL;
PFNGLPROGRAMUNIFORM3IVEXTPROC				glUniform3ivDSA = NULL;
PFNGLPROGRAMUNIFORM4IVEXTPROC				glUniform4ivDSA = NULL;

PFNGLPROGRAMUNIFORMMATRIX2FVEXTPROC			glUniformMatrix2fvDSA = NULL;
PFNGLPROGRAMUNIFORMMATRIX3FVEXTPROC			glUniformMatrix3fvDSA = NULL;
PFNGLPROGRAMUNIFORMMATRIX4FVEXTPROC			glUniformMatrix4fvDSA = NULL;

PFNGLPROGRAMUNIFORMMATRIX2X3FVEXTPROC		glUniformMatrix2x3fvDSA = NULL;
PFNGLPROGRAMUNIFORMMATRIX3X2FVEXTPROC		glUniformMatrix3x2fvDSA = NULL;
PFNGLPROGRAMUNIFORMMATRIX2X4FVEXTPROC		glUniformMatrix2x4fvDSA = NULL;
PFNGLPROGRAMUNIFORMMATRIX4X2FVEXTPROC		glUniformMatrix4x2fvDSA = NULL;
PFNGLPROGRAMUNIFORMMATRIX3X4FVEXTPROC		glUniformMatrix3x4fvDSA = NULL;
PFNGLPROGRAMUNIFORMMATRIX4X3FVEXTPROC		glUniformMatrix4x3fvDSA = NULL;
