...
// q3 style dedicated server and debug console thx to Knightmare

#include "../qcommon/qcommon.h"
#include "resource.h"
#include "winquake.h"

#define CONSOLE_WINDOW_STYLE		(WS_OVERLAPPED|WS_CAPTION|WS_SYSMENU|WS_MINIMIZEBOX|WS_CLIPCHILDREN|WS_GROUP)
#define CONSOLE_WINDOW_CLASS_NAME	"q2xp Console"
#define CONSOLE_WINDOW_NAME			"q2xp Console"


#define MAX_OUTPUT					0x30000 //doom3 size
#define MAX_INPUT					256
#define	MAX_PRINTMSG				0x30000
...
void SaveConsoleLog(void) {
	...
	Com_sprintf(name, sizeof(name), "q2xp.log");
	...
	Com_Printf("Save console log to %s/q2xp.log\n", buf);
}
...
void Sys_InitDedConsole (void)
{
	...
	sys_console.hWndSaveLog = CreateWindowEx(0, "BUTTON", "Save Log", WS_CHILD | WS_VISIBLE | BS_DEFPUSHBUTTON, 155, 425 + LOGO_OFFSET, 70, 25, sys_console.hWnd, NULL, global_hInstance, NULL);
	...
	// Create brushes
	sys_console.hBrushMsg = CreateSolidBrush(RGB(0, 0, 0));
	sys_console.hBrushOutput = CreateSolidBrush(RGB(72, 72, 72)); //cons back color
