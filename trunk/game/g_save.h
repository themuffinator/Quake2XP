...
// func
extern void Com_DefaultExtension ( char * path , size_t maxSize , const char * newExtension ) ;
extern void Com_DefaultPath ( char * path , size_t maxSize , const char * newPath ) ;
...
extern void Q_memcpy ( void * dest , const void * src , const size_t count ) ;
extern void Q_free ( void * buf ) ;
extern void * Q_malloc ( int cnt ) ;
extern void Q_strncpyz ( char * dst , const char * src , size_t dstSize ) ;
extern char * Com_SkipWhiteSpace ( char * data_p , bool * hasNewLines ) ;
extern char * Com_ParseExt ( char * * data_p , bool allowNewLines ) ;
extern void Q_strcat ( char * dst , const char * src , size_t dstSize ) ;
...
extern void BoundsAdd ( vec3_t mins , vec3_t maxs , const vec3_t mins2 , const vec3_t maxs2 ) ;
extern void AddVec4ToBounds ( vec4_t v , vec3_t mins , vec3_t maxs ) ;
...
extern void Extr_Shell ( edict_t * self , char * modelname , vec3_t start , vec3_t aimdir , int speed , vec3_t velocity , char * kierunek ) ;
extern void Extr_Shell_Touch ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
...
extern void Blaster_Fire ( edict_t * ent , vec3_t g_offset , int damage , bool hyper , int effect ) ;
...
extern void ClientAutoGenHealth ( edict_t * ent ) ;
...
extern bool IsNeutral ( edict_t * ent ) ;
...
extern void soldier_step ( edict_t * self ) ;
...
extern void medic_step ( edict_t * self ) ;
...
extern void insane_step ( edict_t * self ) ;
...
extern void infantry_unhead ( edict_t * self ) ;
...
extern void infantry_step ( edict_t * self ) ;
...
extern void gunner_step ( edict_t * self ) ;
...
extern void gladiator_step ( edict_t * self ) ;
...
extern void chick_step ( edict_t * self ) ;
...
extern void brain_step ( edict_t * self ) ;
...
extern void berserk_step ( edict_t * self ) ;
...
extern void fire_blaster ( edict_t * self , vec3_t start , vec3_t dir , int damage , int speed , int effect , bool hyper ) ;
...
extern void LoadStatusbarProgram ( ) ;
extern void Com_sprintf2 ( char * dest , int size , char * fmt , ... ) ;
...
extern void Touch_Corpse ( edict_t * self ) ;
extern void monster_reborn ( edict_t * self ) ;
extern void monster_respawn ( edict_t * self ) ;
...
extern void NetThrowGibs ( edict_t * self , int damage ) ;
extern void WriteScaledDir ( vec3_t vec ) ;
...
extern void Spawn_Gib_Blood ( edict_t * self ) ;
...
extern void Coop_Respawn_Items ( edict_t * ent ) ;
...
extern mmove_t berserk_frames_attack_running_club;
