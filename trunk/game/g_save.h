...
// func
extern void Com_DefaultExtension ( char * path , int maxSize , const char * newExtension ) ;
extern void Com_DefaultPath ( char * path , int maxSize , const char * newPath ) ;
extern void Q_snprintfz ( char * dst , int dstSize , const char * fmt , ... ) ;
extern void Q_strncatz ( char * dst , int dstSize , const char * src ) ;
...
extern void Q_strcat ( char * dst , const char * src , int dstSize ) ;
