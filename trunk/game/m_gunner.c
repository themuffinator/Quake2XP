...
void gunner_step(edict_t *self) {
	...
	n = (rand() + 1) % 4;
	if (n == 0)
		gi.sound(self, CHAN_BODY, sound_step1, 0.25, ATTN_HEAVY_STEPS, 0);
	else if (n == 1)
		gi.sound(self, CHAN_BODY, sound_step2, 0.25, ATTN_HEAVY_STEPS, 0);
	else if (n == 2)
		gi.sound(self, CHAN_BODY, sound_step3, 0.25, ATTN_HEAVY_STEPS, 0);
	else if (n == 3)
		gi.sound(self, CHAN_BODY, sound_step4, 0.25, ATTN_HEAVY_STEPS, 0);
}
...
void SP_monster_gunner (edict_t *self) {
	...
	self->collision_model = TR_Model_Get("gunner", &self->collision_model_index);
