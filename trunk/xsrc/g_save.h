...
extern void weapon_trap_fire(edict_t * ent, bool held);
...
extern bool parasite_drain_attack_ok(vec3_t start, vec3_t end);
...
extern bool gekk_checkattack(edict_t * self);
extern bool gekk_check_jump_close(edict_t * self);
extern bool gekk_check_jump(edict_t * self);
extern bool gekk_check_melee(edict_t * self);
...
extern bool brain_tounge_attack_ok(vec3_t start, vec3_t end);
...
extern void fire_trap(edict_t * self, vec3_t start, vec3_t aimdir, int damage, int speed, float timer, float damage_radius, bool held);
