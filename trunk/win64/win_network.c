...
bool	NET_CompareBaseAdr (netadr_t a, netadr_t b) {
	...
	//	if (a.ip[0] == b.ip[0] && a.ip[1] == b.ip[1] && a.ip[2] == b.ip[2] && a.ip[3] == b.ip[3])
		if (a.ip.u32[0] == b.ip.u32[0] && a.ip.u32[1] == b.ip.u32[1] && a.ip.u32[2] == b.ip.u32[2] && a.ip.u32[3] == b.ip.u32[3])
			return true;
		return false;
	}
...
char	*NET_AdrToString (netadr_t a) {
	...
	if (a.type == NA_LOOPBACK)
		...
		Com_sprintf (s, sizeof(s), "%i.%i.%i.%i:%i", a.ip.u32[0], a.ip.u32[1], a.ip.u32[2], a.ip.u32[3], ntohs (a.port));
	//else
	...
	if ((dwRetVal = GetAdaptersInfo(pAdapterInfo, &ulOutBufLen)) == NO_ERROR) {
		...
		while (pAdapter) {
			...
			if (pAdapter->DhcpEnabled) {
				...
				if (err)
					Com_Printf(S_COLOR_MAGENTA"Invalid Argument to _localtime64_s\n");
				else {
