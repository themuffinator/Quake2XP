...
// NV API SDK & NV Management Library
		...
		for (NvU32 j = 0; j < displayCount; ++j){
			...
			if (ret != NVAPI_OK){
				...
				if (hdrCaps.isST2084EotfSupported){
					...
					hdrColorData.mastering_display_data.displayPrimary_x0				= hdrCaps.display_data.displayPrimary_x0;
					hdrColorData.mastering_display_data.displayPrimary_y0				= hdrCaps.display_data.displayPrimary_y0;
					hdrColorData.mastering_display_data.displayPrimary_x1				= hdrCaps.display_data.displayPrimary_x1;
					hdrColorData.mastering_display_data.displayPrimary_y1				= hdrCaps.display_data.displayPrimary_y1;
					hdrColorData.mastering_display_data.displayPrimary_x2				= hdrCaps.display_data.displayPrimary_x2;
					hdrColorData.mastering_display_data.displayPrimary_y2				= hdrCaps.display_data.displayPrimary_y2;
					hdrColorData.mastering_display_data.displayWhitePoint_x				= hdrCaps.display_data.displayWhitePoint_x;
					hdrColorData.mastering_display_data.displayWhitePoint_y				= hdrCaps.display_data.displayWhitePoint_y;
					hdrColorData.mastering_display_data.max_content_light_level			= hdrCaps.display_data.desired_content_max_luminance;
					hdrColorData.mastering_display_data.max_display_mastering_luminance = hdrCaps.display_data.desired_content_max_luminance;
					hdrColorData.mastering_display_data.max_frame_average_light_level	= 100;
					hdrColorData.mastering_display_data.min_display_mastering_luminance = hdrCaps.display_data.desired_content_min_luminance;
					...
					gl_config.hdrMaxLuminance = hdrCaps.display_data.desired_content_max_luminance;
					if(enableHDR)
