/*
	(c) 2006 willow, based on NVidia SDK
	OpenAL version
...
extern "C" {
    ...
    #ifndef DEFINE_GUID
        #ifndef INITGUID
            #define DEFINE_GUID(name, l, w1, w2, b1, b2, b3, b4, b5, b6, b7, b8) extern const GUID /*FAR*/ name
        #else
    ...
    //
    typedef ALenum (*I3DL2Get)(const GUID* propertySetID, ALuint property, ALuint sourceName, ALvoid* data, ALuint size);
    typedef ALenum (*I3DL2Set)(const GUID* propertySetID, ALuint property, ALuint sourceName, ALvoid* data, ALuint size);

//    #ifndef AL_NO_PROTOTYPES
//        ALenum ALAPIENTRY I3dl2Set(const GUID* propertySetID, ALuint property, ALuint //sourceName, ALvoid* value, ALuint size);
//        ALenum ALAPIENTRY I3dl2Get(const GUID* propertySetID, ALuint property, ALuint //sourceName, ALvoid* value, ALuint size);
