...
keyname_t keynames[] = {
	...
	{ "XPAD_THUMB_LEFT",		K_XPAD_LEFT_THUMB },
	{ "XPAD_THUMB_RIGHT",		K_XPAD_RIGHT_THUMB },
	{ "XPAD_SHOULDER_LEFT",		K_XPAD_LEFT_SHOULDER },
	{ "XPAD_SHOULDER_RIGHT",	K_XPAD_RIGHT_SHOULDER },
	{ "XPAD_A",					K_XPAD_A },
	{ "XPAD_B",					K_XPAD_B },
	{ "XPAD_X",					K_XPAD_X },
	{ "XPAD_Y",					K_XPAD_Y },
...
void Key_Console (int key) {
	...
	if (key == K_ENTER || key == K_KP_ENTER) {	// backslash text are
		// commands, else chat
...
void Key_Event (int key, qboolean down, unsigned time) {
	...
	if ((cls.key_dest == key_menu && menubound[key])
		...
		if (((cls.key_dest == key_console && cls.state == 4)
			|| (cls.key_dest == 0 && cls.state == 1))
